                            ...
                            >
                                ...
                                <DialogContent sx={{ padding: '24px' }}>
                                    <form onSubmit={handleEditSubmit}>
                                        ...
                                        <DialogActions sx={{ padding: '16px 0', borderTop: '1px solid #E5E5EA', display: 'flex', justifyContent: 'space-between' }}>
                                            <Box>
                                                <CancelButton sx={{ marginRight: '20px' }} onClick={handleEditCancel}>Отмена</CancelButton>

...
function Dashboard() {
  ...
  return (
    <Container
      ...
      sx={{
        mt: 4,
        // Убрано minHeight, чтобы контейнер подстраивался под содержимое
        backgroundColor: '#FFFFFF',
        borderRadius: '16px',
        boxShadow: '0 4px 12px rgba(0, 0, 0, 0.05)',
        ...
        <CardContent>
          ...
          {loadingInitial ? (
            ...
            <>
              ...
              >
                <DialogTitle sx={{ color: '#1D1D1F', fontWeight: 600, borderBottom: '1px solid #E5E5EA' }}>Редактировать публикацию</DialogTitle>
                <DialogContent sx={{ padding: '24px' }}>
              ...
              >
                <DialogTitle sx={{ color: '#1D1D1F', fontWeight: 600, borderBottom: '1px solid #E5E5EA' }}>Редактировать личные данные</DialogTitle>
                <DialogContent sx={{ padding: '24px' }}>
              ...
              >
                <DialogTitle sx={{ color: '#1D1D1F', fontWeight: 600, borderBottom: '1px solid #E5E5EA' }}>Прикрепить файл к публикации</DialogTitle>
                <DialogContent sx={{ padding: '24px' }}>
                  <Box sx={{ mt: 2, mb: 2 }}>
                    <input
                      type="file"
              ...
              >
                <DialogTitle sx={{ color: '#1D1D1F', fontWeight: 600, borderBottom: '1px solid #E5E5EA' }}>Изменить пароль</DialogTitle>
                <DialogContent sx={{ padding: '24px' }}>
